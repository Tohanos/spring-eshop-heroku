...
import com.kravchenko.springeshop.endpoint.GreetingEndpoint;
import com.kravchenko.springeshop.endpoint.ProductsEndpoint;
...
public class WebServiceConfig {
    ...
    public DefaultWsdl11Definition defaultWsdl11Definition() {
        ...
        wsdl11Definition.setSchema(xsdGreetingsSchema());
        return wsdl11Definition;
    }

    @Bean("greetingSchema")
    public XsdSchema xsdGreetingsSchema() {
